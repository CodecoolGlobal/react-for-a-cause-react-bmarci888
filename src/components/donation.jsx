    ...
    return (
        <div className="supportContainer">
            ...
            <div className="donationOptions">
                <label>
                    <input type={"radio"} className={"radioButton"} name="paymentOption" checked={isCard} onChange={handleOptionClick} />
                    Credit/Debit Card
                </label>
                <label>
                    <input type={"radio"} className={"radioButton"} name="paymentOption" onChange={handleOptionClick} />
                    PayPal
                </label>
            </div>
            {isDonated ? <Message setIsDonated={setIsDonated} /> : isCard ? <DonationForm setIsDonated={setIsDonated} /> : <PayPalForm setIsDonated={setIsDonated} />}
        </div>
    );
}
    ...
    return (
        <div className="donationContainer">
            <div className={"card"}>
                ...
                <label>Name:  <input className={"allInputs"} /></label>
                <br />
                <label>Card Number: <input className={"allInputs"} /></label>
                <br />
                <label>Card Expiration:  <input className={"expInput allInputs"} type={"month"} /></label>
                <br />
                <label>Security Code: <input className={"smallInputs allInputs"} /></label>
                <br />
                <label>Amount in USD: <input className={"smallInputs allInputs"} /></label>
                <br />
                <img className="creditCards" alt="card images" src={cardImages} />
                <br />
                <button className="buttons" onClick={() => HandleClick(setIsDonated)}>Donate!</button>
            </div>
